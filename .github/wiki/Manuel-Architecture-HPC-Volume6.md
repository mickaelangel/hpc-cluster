...
- MPI, [Slurm](Guide-SLURM-Complet.md), [Lustre](Glossaire-et-Acronymes.md#l) (Ch. 21)
...
- **[Manuel Architecture HPC — Vol. 1 à 5](Manuel-Architecture-HPC-Volume1.md)** : fondations, réseaux, stockage, Slurm, toolchains
- **[Guide SLURM Complet](Guide-SLURM-Complet.md)** : partitions, topology, task/affinity
- **[Glossaire et Acronymes](Glossaire-et-Acronymes.md)** : NUMA, TLB, HPL, HPCG, etc.
