...
2. **Premiers-Pas.md** - Démarrage rapide (connexion, premier job, liens utiles)
3. **Installation-Rapide.md** - Guide d'installation en 5 minutes
4. **Configuration-de-Base.md** - Configuration minimale fonctionnelle
5. **FAQ.md** - Questions fréquentes
6. **Depannage.md** - Guide de résolution de problèmes
7. **Astuces.md** - Astuces et optimisations
8. **Commandes-Utiles.md** - Référence rapide des commandes
9. **Monitoring.md** - Guide complet du monitoring
10. **IDEES-AJOUTS.md** - Suggestions d’ajouts pour le wiki et le projet
