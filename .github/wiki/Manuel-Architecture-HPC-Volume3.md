...
- Réseaux HPC (InfiniBand, RDMA) — [Volume 2](Manuel-Architecture-HPC-Volume2.md) — Ch. 9–10
...
- **[Cours HPC Complet](Cours-HPC-Complet.md)** : concepts, stockage, parallélisme
- **[Glossaire et Acronymes](Glossaire-et-Acronymes.md)** : Lustre, MDS, OST, LNet, HSM, etc.
